...
O benchmark confirma a especialização de cada tecnologia. As consultas, embora idênticas em seu objetivo de negócio, demonstram uma diferença de performance gritante:
